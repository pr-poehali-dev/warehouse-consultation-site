          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-foreground mb-6 leading-relaxed">
                ...
                я помогаю компаниям оптимизировать процессы хранения товаров глубокой заморозки. 
                Моя экспертиза включает проектирование складских пространств, выбор оборудования для 
                низкотемпературных условий и решение сложных логистических задач.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-foreground">
                    Разработка 50+ проектов складов с системами глубокой заморозки
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Icon name="CheckCircle" className="text-primary mt-1 flex-shrink-0" size={20} />
                  <p className="text-foreground">
                    Оптимизация логистики для 20+ компаний в сфере пищевой промышленности
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Icon name="CheckCircle" className="text-primary mt-1 flex-shrink-0" size={20} />
                  <p className="text-foreground">
                    Соответствие ТР ТС 028/2012 и международным стандартам качества
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="transition-all hover:shadow-xl hover:-translate-y-1 animate-fade-in">
              <CardContent className="p-8">
                ...
                <p className="text-foreground leading-relaxed">
                  Консультация по выбору оборудования, проектированию холодильных зон, 
                  оптимизации энергопотребления и соблюдению нормативов (ТР ТС 028/2012).
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="transition-all hover:shadow-xl hover:-translate-y-1 animate-fade-in">
              <CardContent className="p-8">
                ...
                <p className="text-foreground leading-relaxed">
                  Проектирование складских пространств под специфические задачи: расчет грузоподъемности, 
                  выбор материалов для низкотемпературных условий, интеграция систем автоматизации.
                </p>
              </CardContent>
            </Card>
