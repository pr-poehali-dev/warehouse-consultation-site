          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="transition-all hover:shadow-xl hover:-translate-y-1 animate-fade-in">
              <CardContent className="p-8">
                ...
                <p className="text-foreground leading-relaxed">
                  Проектирование холодильного склада включает расчет зон приемки, разгрузки, тамбуров, камер хранения, комплектации и технических помещений с учетом материалов, и автоматизации для эффективной работы в низких температурах.
                </p>
              </CardContent>
            </Card>
