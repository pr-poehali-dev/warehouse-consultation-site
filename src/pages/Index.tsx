          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="transition-all hover:shadow-xl hover:-translate-y-1 animate-fade-in">
              <CardContent className="p-8">
                ...
                <p className="text-foreground leading-relaxed">
                  Консультация по выбору оборудования, проектированию холодильных зон, оптимизации энергопотребления
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="transition-all hover:shadow-xl hover:-translate-y-1 animate-fade-in">
              <CardContent className="p-8">
                ...
                <p className="text-foreground leading-relaxed">
                  Складское Пространство. Проектирование складского пространства с учетом конкретных требований: расчет зоны приемки и разгрузки, переходные зоны и тамбуры, основная холодильная камера, зона комплектации и отгрузки, технические помещения. Расчет грузоподъемности, выбор материалов для низкотемпературных условий, интеграция системы автоматизации.
                </p>
              </CardContent>
            </Card>
